import { isSpecialEquipmentText } from "./special-vehicle"
...
/** Бензин и гибриды — да; дизель легковых и чистый электро — нет. Спецтехника (Bongo и т.п.) — да. */
export function isAllowedCatalogFuel(
  fuel?: string | null,
  ...textParts: Array<string | null | undefined>
): boolean {
  if (isSpecialEquipmentText(fuel, ...textParts)) return true
